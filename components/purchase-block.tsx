  ...
  return (
    <section className="py-[var(--section-padding-y)] bg-[var(--color-base)]">
      <div className="container">
        ...
        >
          <BorderBeam>
            <div className="p-6 sm:p-8 md:p-12 flex flex-col items-center rounded-[calc(var(--radius-card)-1px)] bg-[var(--color-surface)]">
              <h2 className="text-base font-medium text-[var(--color-text-muted)] tracking-[0.04em] uppercase text-center mb-6">
